...
const registerWhatsappTest = require('./src/middleware/register-whatsapp-test')
...
const companyNameRoutes = require('./src/routes/company-name')
const saasRoutes = require('./src/routes/saas')
const auditV2Routes = require('./src/routes/audit-v2')
const billingRoutes = require('./src/routes/billing')
const billingLegalRoutes = require('./src/routes/billing-legal')
const operationsRoutes = require('./src/routes/operations')
const materialRepricingTestRoutes = require('./src/routes/material-repricing-test')
...
const disposableTestOrigins = new Set([
  ...
  'https://pdf-layout-producao.estofaria-frontend.pages.dev',
...
app.use('/api/auth/register', registerWhatsappTest(storeLib))
app.use('/api/auth', authRoutes)
app.use('/api/saas', auditV2Routes)
app.use('/api/saas', companyNameRoutes)
app.use('/api/saas', saasRoutes)
app.use('/api/billing', billingLegalRoutes)
app.use('/api/billing', billingRoutes)
app.use('/api', legacyApiPermissions)
app.use('/api', materialRepricingTestRoutes)

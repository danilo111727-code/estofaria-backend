function load(){
  ...
  function getConfig(){
  return JSON.parse(localStorage.getItem("agenda_config")||'{"prazo":0,"vagas":0,"tipoDias":"corrido"}')
  }
  ...
  let configurado=conf.prazo>0&&conf.vagas>0

  if(!configurado){
  document.getElementById("barra").style.width="0%"
  document.getElementById("barraTexto").innerText="—"
  document.getElementById("nextProd").innerText="—"
  document.getElementById("nextEnt").innerText="—"
  return
  }
